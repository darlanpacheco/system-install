...
pacman -Syu --needed efibootmgr grub networkmanager pipewire-pulse pipewire-jack vulkan-radeon cpupower linuxconsole libappimage dosfstools gstreamer gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly xdg-desktop-portal-hyprland xdg-desktop-portal-gtk wayland flatpak gammastep ranger mpv btop nmap slurp grim rclone rsync git git-lfs trash-cli 7zip eza chafa ollama wl-clipboard openssh ufw fastfetch docker docker-compose hyprpicker hyprland waybar alacritty rofi neovim gcc mingw-w64-gcc clang zig zls rust shfmt npm nodejs lua-language-server stylua adw-gtk-theme breeze5 noto-fonts noto-fonts-cjk noto-fonts-emoji ttf-jetbrains-mono ttf-jetbrains-mono-nerd papirus-icon-theme
